...
from lead.views import (LeadEventCreateView, LeadEventListView,
                        LeadFollowupListView, LeadFollowupRuleListView,
                        LeadListView)
...
urlpatterns = [
    ...
    path('lead_event_create/', LeadEventCreateView.as_view(), name='lead-event-create')
]
